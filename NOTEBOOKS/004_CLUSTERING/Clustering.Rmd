...
fviz_dend(res.hcpc, 
          cex = 0.7,                     # Label size
          palette = c("#0073C2","#868686","#EFC000"),               # Color palette see ?ggpubr::ggpar
          rect = TRUE, rect_fill = TRUE, # Add rectangle around groups
          rect_border = c("#0073C2","#868686","#EFC000"),           # Rectangle color
...
# Visualize in Phylogenic manner: 
fviz_dend(res.hcpc, k = 5, # Cut in five groups
          k_colors = c("#0073C2","#868686","#EFC000"),
          type = "phylogenic", repel = TRUE,
          phylo_layout = "layout.gem"
)
