...
happiness <- read.csv("DATA/WorldAnalysis.csv", stringsAsFactors = FALSE)
#If trouble using this code to import the file, go to DATA folder, click on the file and import it manually
```
