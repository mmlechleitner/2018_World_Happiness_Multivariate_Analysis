...
ggcorrplot(FA_Loadings, lab=T, insig ="blank") + coord_flip() + ggtitle("FA Quality of Representation")
ggcorrplot(PCA_Loadings, lab=T, insig ="blank") + coord_flip() + ggtitle("PCA Quality of Representation")
